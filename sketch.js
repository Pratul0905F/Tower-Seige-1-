...
// level one
block1 = new Block(640,275,30,40)
block2 = new Block(670,275,30,40)
block3 = new Block(700,275,30,40)
block4 = new Block(730,275,30,40)
block5 = new Block(760,275,30,40)
//level two
...
fill("gold")
imageMode(CENTER)
image(polygon_img,ball.poition.x,ball.position.y,40,40)
slingshot.display()
}
